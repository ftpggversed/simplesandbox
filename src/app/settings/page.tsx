...
export default function SettingsPage() {
  ...
  useEffect(() => { localStorage.setItem('autoRun', String(autoRun)); }, [autoRun]);
  useEffect(() => { localStorage.setItem('syntaxTheme', syntaxTheme); }, [syntaxTheme]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-gray-800 rounded-xl p-6 shadow-md md:col-span-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <select
                value={syntaxTheme}
                onChange={(e: ChangeEvent<HTMLSelectElement>) => setSyntaxTheme(e.target.value)}
                className="px-3 py-2 bg-gray-700 rounded-md"
              >
